...
<div id="StatusBar">
    ...
    <div id="StatusBar_Right">
		...
		<a href="javascript:void(0)">
			<img border="0" width="11" height="11" src="${pageContext.request.contextPath}/houtai/detail/style/images/info.gif" /> 
			<img border="0" width="40" height="11" src="${pageContext.request.contextPath}/houtai/detail/style/images/version.gif" />
		</a>
    </div>
</div>
