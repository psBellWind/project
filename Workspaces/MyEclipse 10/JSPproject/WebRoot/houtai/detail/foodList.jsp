...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="${pageContext.request.contextPath}/houtai/detail/style/images/title_arrow.gif"/> 菜品列表
		</div>
    </div>
...
<div id="MainArea">
    <table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
        ...
        <%List<Food> foods=(ArrayList<Food>)request.getAttribute("foods");
        	request.setAttribute("foodsNext", foods);
         %>
         
			<c:forEach var="list" items="${requestScope.foods}" varStatus="vs">
				<tr class="TableDetail1">
	            	...
	            	<td>${list.mprice}&nbsp;</td>
					<td>
						<a href="${pageContext.request.contextPath}/servlet/FoodServlet?foodId=${list.id}&thing=findById"  class="FunctionButton">更新</a>		
						<%-- /houtai/detail/updateFood.jsp?typeName=${list.typeName}&foodName=${list.foodName}&price=${list.price}&mprice=${list.mprice}&remark=${list.remark}&img=${list.img}&foods=${requestScope.foodsNext} --%>		
						<a href="${pageContext.request.contextPath}/servlet/FoodServlet?foodId=${list.id}&thing=delete" onClick="return delConfirm();"class="FunctionButton">删除</a>				
					</td>
				</tr>
			</c:forEach>
			<%-- <tr class="TableDetail1">
                ...
                <td>23.0&nbsp;</td>
				<td>
					<a href="${pageContext.request.contextPath}/houtai/detail/updateFood.jsp"  class="FunctionButton">更新</a>				
   ...
   <!-- 其他功能超链接 -->
	<div id="TableTail" align="center">
		<div class="FunctionButton"><a href="${pageContext.request.contextPath}/servlet/FoodServlet?thing=addFood">添加</a></div>
    </div> 
</div>
</body>
</html>
