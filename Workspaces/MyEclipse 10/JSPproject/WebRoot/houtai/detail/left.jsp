    ...
    <ul id="Menu">
	    <li class="level1">
            <div onClick="menuClick(this);" class="level1Style">
				<img src="${pageContext.request.contextPath}/houtai/detail/style/images/func20001.gif" class="Icon" /> 
				系统菜单
			</div>
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="${pageContext.request.contextPath}/servlet/DinnerTableServlet?thing=findAllTable">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath}/servlet/CaidanServlet?thing=findAllCaiType">菜系管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath}/servlet/FoodServlet?thing=findAllFood">菜品管理</a>
				</li>
                <li class="level2 level2Style">								<!-- /servlet/OrderServlet?thing=findAllOrder -->
                	<a target="right" href="${pageContext.request.contextPath}/houtai/detail/orderList.jsp">餐厅订单</a>
				</li>
            </ul>
        </li>
    </ul>
