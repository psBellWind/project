...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
					...
					<img border="0" width="13" height="13" src="${pageContext.request.contextPath}/houtai/detail/style/images/title_arrow.gif"/>  添加菜系
					...
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
								...
								<input type="hidden" name="thing" value="addType" />
							</td>
						</tr>
					</table>
				</div>
