...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
					...
					<img border="0" width="13" height="13" src="${pageContext.request.contextPath}/houtai/detail/style/images/title_arrow.gif"/> 添加新菜品
				...
				<div class="ItemBlock2">
                    ...
                    <tr>
						...
						<tr>
							...
							<td>
								<input type="hidden" value="addFood" name="thing"/>
