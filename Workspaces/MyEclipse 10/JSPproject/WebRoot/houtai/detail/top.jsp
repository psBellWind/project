...
#Head_1 {
    background: url("${pageContext.request.contextPath}/houtai/detail/style/images/img/top_head1_bg.gif") repeat-x scroll 0 0 transparent;
    height: 64px;
    margin: 0 auto;
    width: 100%;
}
...
#Head_2 {
   background: url("${pageContext.request.contextPath}/houtai/detail/style/images/img/top_head2_bg.gif") repeat-x scroll 0 0 transparent;
...
<body>
	...
	<div id="Head_1">
		<!-- 标题 -->
		<div id="Head_1_Logo">
			<b style="font-family: '黑体'">武汉酒店信息管理平台</b> <!-- <img border="0" src="style/images/logo.png" /> -->
        </div>
		<!-- 欢迎用户的文字 -->
		<div id="Head_1_UserWelcome">
			<img border="0" width="13" height="14" src="${pageContext.request.contextPath}/houtai/detail/style/images/user.gif" /> 
			您好，<b>管理员</b>
		</div>
		<!-- 一些链接按钮 -->
		<div id="Head_1_FunctionButton">
			<a target="right" href="javascript:void(0)">
				<img width="78" height="20" src="${pageContext.request.contextPath}/houtai/detail/style/images/help2.gif" />
			</a>
			<a target="_parent" href="javascript:void(0)">
				<img width="78" height="20" alt="退出系统" src="${pageContext.request.contextPath}/houtai/detail/style/images/logout.gif" />
			</a>
		</div>
	</div>
	<!-- 下部 -->
    <div id="Head_2">
		...
		<div class="Head2_FunctionList" style="float:left">
			<a href="javascript: window.parent.right.history.back();">
				<img src="${pageContext.request.contextPath}/houtai/detail/style/images/Header_back.gif" width="24" height="24" style="margin-top: -8px;"/>
				<b>后退</b>
			</a>
			<a href="javascript: window.parent.right.history.forward();">
				<img src="${pageContext.request.contextPath}/houtai/detail/style/images/Header_forward.gif" width="24" height="24" style="margin-top: -8px;"/>
				<b>前进</b>		
			</a>
        </div>
		...
		<div id="Head2_FunctionList">
			...
			<a href="javascript: window.parent.right.history.go(0);">
				<img src="${pageContext.request.contextPath}/houtai/detail/style/images/Header_refresh.gif" width="24" height="24" style="margin-top: -8px;"/>
				<b>刷新(IE、Chrome)</b>		
			</a>
