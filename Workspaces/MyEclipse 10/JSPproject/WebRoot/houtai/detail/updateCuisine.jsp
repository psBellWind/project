...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
					...
					<img border="0" width="13" height="13" src="${pageContext.request.contextPath}/houtai/detail/style/images/title_arrow.gif"/>  更新菜系
...
<div id="MainArea">
	...
	<form action="${pageContext.request.contextPath}/servlet/CaidanServlet" method="post">
		...
		<div class="ItemBlock_Title">
        	<img width="4" height="7" border="0" src="${pageContext.request.contextPath}/houtai/detail/style/images/item_point.gif"> 菜系信息&nbsp;
        </div>
		<!-- 本段表单字段 -->
						...
						<tr>
							...
							<%String typeName=request.getParameter("typeName");
							 ...
							 %>
								...
								<input type="text" name="name" class="InputStyle" value="${requestScope.typeName}"/> *
								<input type="hidden" name="thing" value="updateType" />
