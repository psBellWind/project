...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/qiantai/detail/style/css/index_1.css" />
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/qiantai/detail/style/css/dis_message.css" />
</head>
	...
	<div id="all">
		...
		<div id="menu1">
			<div class="menu2" style="text-align:center;">
				<img src="${pageContext.request.contextPath}/qiantai/detail/style/images/order_detials_bg.png" />
			</div>
			<div class="menu3">
				<div class="menu3_left">
				
					<img src="${pageContext.request.contextPath}/${requestScope.food.img}"
			...
			<div class="menu4">
				...
				<a href="${pageContext.request.contextPath}/servlet/QFoodServlet?thing=findFoodByIdCar&foodId=${requestScope.food.id}" style="background:url(${pageContext.request.contextPath}/qiantai/detail/style/images/img/order_left_corner_bg.png);">放入餐车</a>
				<a href="#" onclick="javascript:history.go(-1);" style="background:url(${pageContext.request.contextPath}/qiantai/detail/style/images/img/order_right_corner_bg.png);">返回</a>
			</div>
		</div>
